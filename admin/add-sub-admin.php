...
<script src="http://code.jquery.com/jquery-1.11.1.min.js"></script> 
			...
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">ADD SUB ADMIN</h3>
					<script src="js/jquery.min.js"> </script>
					
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal"  id="registerSubAdmin" action="../ajax/add-sub-admin.php" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="name"  class="form-control1" id="name" placeholder="Name" required>
									</div>
  								...
  								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="email" name="email" id="email" class="form-control1" id="focusedinput" placeholder="Example@gmail.com" required>
									</div>
									<!--<div class="col-sm-2 jlkdfj1">
										<p class="help-block">Your help text!</p>
									</div>-->
