...
$viewOrders= $adminService->viewOrders();
...
?>
	...
	<?php  } ?>
					...
					<h3 class="blank1">NEW ORDER(S)</h3>
						...
						<table class="table">
						  ...
						  <?php  foreach ($viewOrders as $viewOrder) {
							...
							<?php  foreach ($viewTypes as $viewType) {
							  ...
							  <td><a href="../ajax/confirm-order.php?orderId=<?php echo $viewOrder['ORDER_ID']; ?>" class="btn-success btn">Confirm</a></td>

							  <!--<td><a href="../ajax/process-order.php?orderId=<?php /*?><?php echo $viewOrder['ORDER_ID'] ?><?php */?>">Process Order</a></td>

							  <td><a href="../ajax/complete-order.php?orderId=<?php /*?><?php echo $viewOrder['ORDER_ID'] ?><?php */?>">Complete Order</a></td>-->
